...
//code designed to keep bot online, pings every five minutes
...
Cayde.on("message", message => {
 ...
 {
 const allEmoji = Cayde.emojis.get(emojiID);
 ...
 "What is your problem? That's terrible!",
...
//447 lines of pure code, :FeelsGoodMan:
